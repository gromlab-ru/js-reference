...
1. Найди существующий sprite и его public entry по [`technologies/svg-sprites.md#использование`](../../../technologies/svg-sprites.md#использование).
2. Если sprite отсутствует или требует regeneration, используй [`technologies/svg-sprites.md#создание-и-генерация`](../../../technologies/svg-sprites.md#создание-и-генерация).
...
- Для сложного SVG выполняется проверка по [`technologies/svg-sprites.md#сложные-svg`](../../../technologies/svg-sprites.md#сложные-svg).
