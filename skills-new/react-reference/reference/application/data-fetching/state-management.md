...
Точные правила server state применяй по [`libraries/swr/get-data.md`](../../libraries/swr/get-data.md) и [`libraries/swr/subscriptions.md`](../../libraries/swr/subscriptions.md).
