...
Этот документ определяет подключение realtime к React lifecycle. Технический контракт keys, subscribe callback, cleanup, sync payload, auth scope и reconnect применяй по [`libraries/swr/subscriptions.md`](../../libraries/swr/subscriptions.md).
