...
именование значений и типов, runtime-проверки и JSDoc. Проектные правила форматирования, файлов и module boundaries
определяет [`code-style.md`](../../code-style.md).
...
Каждый `type`, `interface`, `enum` и каждое их поле или значение имеют JSDoc. Константу документируй, если это
публичный контракт, domain restriction, magic value или переиспользуемая configuration.
